...
## Booleans
저번 단원에서 명제의 참또는 거짓으로 코드의 흐름을 바꾸는 방법에 대해 알아보았습니다. 어떤 명제를 코드에 활용할때, 그 명제의 참 여부를 변수로 사용할 수 있는 data tyoe이 있습니다. 바로 Boolean 입니다.        

Boolean 변수는 둘 중 하나의 값을 가집니다. True와 False입니다. 
